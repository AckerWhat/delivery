    ...
    <div className='navbar'>
      <Link to='/'><img src={assets.logo} alt="" className="logo" /></Link>
        <ul className="navbar-menu">
            ...
            <a href='#app-download' onClick={()=>setMenu("aplicación movil")} className={menu==="aplicación movil"?"active":""}>aplicación movil</a>
            <a href='#footer' onClick={()=>setMenu("contactos")} className={menu==="contactos"?"active":""}>contactos</a>
        </ul>
